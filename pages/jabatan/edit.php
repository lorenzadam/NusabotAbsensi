...
$result =  mysqli_fetch_row(mysqli_query($mysqli, "SELECT * FROM pengguna where nomor_induk = '{$_GET['id']}'"));
?>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <a href="../pengguna" class="btn btn-app">
                        ...
                        <div class="col-12">
                            <div class="card card-warning">
                                ...
                                <form method="post" action="index.php">
                                    <input type="hidden" name="nomor_induk_lama" value="<?= $result[0] ?>">
                                    <input type="hidden" name="nama_lama" value="<?= $result[1] ?>">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php comboBoxSelectEdit($mysqli, 'jabatan_status', 'id', 'jabatan_status', 'jabatan_status', 1, $result[3], getAnyTampil($mysqli, "jabatan_status", "jabatan_status", "id", $result[3])) ?>
                                        </div>
                                        <div class="form-group">
